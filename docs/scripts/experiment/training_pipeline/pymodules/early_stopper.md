...
The `pymodules/early_stopper.py` Python file defines the early stopper object. When imported, this file must create the following variable:
  ...
  - `early_stopper`: An instance of a subclass of `gorideep.early_stoppers.base.BaseEarlyStopper`. This is the early stopper that will be used through the training pipeline.
